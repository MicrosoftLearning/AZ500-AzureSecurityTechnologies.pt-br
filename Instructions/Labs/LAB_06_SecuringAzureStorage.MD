...
![Diagrama mostrando o fluxo do processo das tarefas no laboratório.](../media/service-endpoints-and-securing-storage-diagram.png)
...
3. Na folha **myVMPrivate**, clique em **Conectar** e, no menu suspenso, clique em **Conectar**. 

4. Baixe o arquivo RDP e use-o para se conectar à VM **myVMPrivate** do Azure por meio da Área de Trabalho Remota. Quando a autenticação for solicitada, forneça esta credenciais do Azure:
...
3. Na folha **myVMPublic**, clique em **Conectar** e, no menu suspenso, clique em **Conectar**. 

4. Clique em **Conectar via RDP** e use essa opção para se conectar à VM **myVMPublic** do Azure por meio da Área de Trabalho Remota. Quando a autenticação for solicitada, forneça esta credenciais do Azure:
