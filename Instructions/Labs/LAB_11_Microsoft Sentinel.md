...
![Diagrama do fluxo do processo das tarefas neste laboratório.](../media/microsoft-sentinel-diagram.png)
...
6. No painel **Atividade do Azure**, a guia **Instruções** deve ser selecionada, observe os **Pré-requisitos** e role para baixo até a **Configuração**. Anote as informações que descrevem a atualização do conector. Sua assinatura nunca usou o método de conexão herdado, então você pode ignorar a etapa 1 (o botão **Desconectar tudo** ficará esmaecido) e prosseguir para a etapa 2.
